...
## 👨‍💻 O que foi desenvolvido:
  ...
  - Foi desenvolvido uma aplicação de cadastro de talkers (palestrantes) em que é possível cadastrar, visualizar, pesquisar, editar e excluir informações. Para isso foi feito:
  1. Desenvolvimento de uma API REST com Express de um `CRUD` (**C**reate, **R**ead, **U**pdate e **D**elete) de palestrantes (talkers) e;
  2. Desenvolvimento de alguns endpoints que realizam a leitura e escrita em um arquivo utilizando o módulo `fs`.
